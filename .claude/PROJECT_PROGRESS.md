...
## Current Focus
Phase 8: Collections & Sharing — sub-phase A complete (collection CRUD, add/remove recipes, visibility, frontend pages). Sub-phase B (add-to-collection from recipe detail) is next.

## Active Tasks
- [NEXT] Phase 8B: Add-to-Collection from recipe detail + recipe membership endpoint
...
## Next Session
1. **Phase 8B**: Add-to-Collection from recipe detail page
2. **Phase 8C**: Cross-household sharing, recipe copy, bulk export
